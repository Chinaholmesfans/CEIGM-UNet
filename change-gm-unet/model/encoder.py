...
from model.gm import ENCODERS as ENCODERS2
from model.gm import GroupMamba
...
class Encoder2(nn.Module):
    def __init__(self, name: str, in_channels: int = 3, **kwargs: Any) -> None:
        ...
        self.gm_encoder: GroupMamba = ENCODERS2[name](in_chans=in_channels, **kwargs)
        self.dims = self.gm_encoder.dims
