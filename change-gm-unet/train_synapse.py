...
class Synapse(L.LightningModule):
    ...
    def prepare_data(self) -> None:
        ...
        self.train_dataset = SynapseDataset(
            base_dir="/root/autodl-tmp/edata/Synapse/train_npz",
            split="train",
            norm_x_transform=self.norm_x_transform,
            norm_y_transform=transforms.ToTensor(),
        )

        self.val_dataset = SynapseDataset(base_dir="/root/autodl-tmp/edata/Synapse/test_vol_h5", split="test_vol")
    ...
    def on_train_epoch_start(self) -> None:
        ...
        if self.current_epoch >= 250:
            self.log_and_logger("training complete", 1)
    ...
    def on_validation_epoch_end(self) -> None:
        ...
        self.last_dice = np.mean(avg_metric)
...
if __name__ == "__main__":
    ...
    train("/root/autodl-tmp/log/gm-unet-synapse")
